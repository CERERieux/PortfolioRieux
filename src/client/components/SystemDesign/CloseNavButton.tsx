...
export function CloseNavButton({
  ...
  return (
    <button
      className={`hover absolute ${position} rounded-full bg-slate-50 px-3 py-1 text-black transition-all hover:scale-110 hover:bg-red-500 hover:text-white hover:shadow-lg hover:shadow-red-500/40 active:scale-90 active:bg-slate-900 active:shadow-none`}
