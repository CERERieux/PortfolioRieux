...
export default function DrumMachine() {
  ...
  return (
    <main className="grid h-full w-full grid-cols-1 place-items-center">
      <div className="grid h-1/3 w-2/3 grid-cols-2 grid-rows-2 place-items-center justify-around border border-black bg-zinc-800 bg-gradient-to-b from-slate-500 via-transparent via-10% to-zinc-950 to-90% shadow-lg shadow-zinc-400 sm:w-1/2 md:h-2/5 md:w-2/5 lg:w-1/3">
