...
export default function SingleIssueAdmin({
  created,
  id,
  issue,
  updated,
  ...
  const handleViewUpdate = () => {
    setIsUpdate({ isUpdating: true, id });
  };
  ...
  return (
    <article className="relative flex flex-col justify-center gap-1 px-4">
      ...
      <ActionButton
        ...
        groupName={["group/delete", "group-hover/delete:block"]}
        position="md:top-4 md:right-16 top-2 right-16"
        tooltipText="Delete Issue"
        tooltipPos="-left-[2px] -bottom-8"
        onClick={removeIssue}
      >
        <TrashCan />
      </ActionButton>
