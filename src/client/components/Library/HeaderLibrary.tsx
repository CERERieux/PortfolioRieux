...
export default function HeaderLibrary({
  ...
  return (
    <section className="w-full px-4 md:w-2/3">
      <h2 className="text-pretty text-center font-elegant text-3xl first-letter:text-5xl first-letter:text-lime-400">
        Add books to your library!
      </h2>
      <div className="flex w-full items-center justify-center gap-4 font-buttonCalculator">
        <Button
          color="bg-lime-300 border-lime-500 hover:bg-lime-600 hover:border-lime-300 flex justify-center items-center gap-2 transition-all"
          xSize="w-48 h-10"
          id={idOpen}
        >
          <PencilPlus size="20" />
        ...
        <Button
          color="bg-red-300 border-red-500 hover:bg-red-600 hover:border-red-300 flex justify-center items-center gap-2 transition-all"
          xSize="w-48 h-10"
          disabled={disabled}
          id={idDelete}
        >
      ...
      >
        <section>
          ...
          <div className="mt-2 flex w-full items-center justify-center gap-2">
            ...
            <Button
              color="bg-red-300 border-red-500 hover:bg-red-600 hover:border-red-300 transition-all"
