...
export default function FilterBooks({
  ...
  return (
    <section className="flex w-full flex-col items-center gap-2 rounded-md bg-white px-4 py-2 shadow-md shadow-black/20 md:absolute md:right-2 md:top-1/3 md:w-[32%] lg:right-8 lg:w-[28%] xl:right-12 xl:w-[25%]">
