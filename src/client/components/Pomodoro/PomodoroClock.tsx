    ...
    <>
      ...
      >
        <section className="relative flex w-fit justify-center gap-2">
          <h1 className="mb-6 rounded-2xl bg-slate-50/80 px-4 pb-2 pt-1 font-digitalDisplay text-4xl text-black/85 shadow-lg shadow-black md:text-5xl dark:bg-slate-600/80 dark:text-slate-200">
            {text[0]}
          </h1>
          <OpenInfo
          ...
          >
            <h3 className="text-lg text-lime-600 dark:text-lime-300">
              {text[1]}
            </h3>
            <p className="max-w-[600px] self-start text-pretty">
              ...
              <em>{text[5]}</em>
              {text[6]}
              <span className="text-red-600 dark:text-red-300">{text[7]}</span>
              {text[8]}
              <span className="text-red-600 dark:text-red-300">{text[9]}</span>
              {text[10]}
              <span className="text-blue-600 dark:text-sky-200">
                {text[11]}
              </span>
              {text[12]}
              <span className="text-blue-600 dark:text-sky-200">
        ...
        <div className="relative flex h-3/4 w-full flex-col items-center justify-center gap-2 bg-slate-100/65 shadow-inner shadow-black/40 md:h-1/2 md:w-3/4 md:flex-row md:rounded-3xl md:bg-slate-100/80 md:shadow-lg md:shadow-black lg:w-3/5 dark:bg-slate-600/80 dark:text-slate-200">
          <SessionBox
